...
export function getProvider(
  ...
  | { id: ProviderId; name: string; description: string; models: string[] }
  | undefined {
...
export function getApiKey(
  ...
  const isOllamaModel =
    provider === "ollama" ||
    useProvidersStore.getState().providers.ollama.models.includes(model);
  if (isOllamaModel) {
...
/**
 * Update Ollama provider models dynamically (client-safe)
 */
...
/**
 * Update vLLM provider models dynamically (client-safe)
 */
...
/**
 * Update OpenRouter provider models dynamically (client-safe)
 */
