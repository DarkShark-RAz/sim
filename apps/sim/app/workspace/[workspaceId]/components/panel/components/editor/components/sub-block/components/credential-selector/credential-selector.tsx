...
import { OAuthRequiredModal } from '@/app/workspace/[workspaceId]/components/panel/components/editor/components/sub-block/components/credential-selector/components/oauth-required-modal'
