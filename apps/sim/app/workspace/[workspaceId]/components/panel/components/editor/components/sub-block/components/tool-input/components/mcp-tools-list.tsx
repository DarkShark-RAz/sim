...
import { ToolCommand } from '@/app/workspace/[workspaceId]/components/panel/components/editor/components/sub-block/components/tool-input/components/tool-command/tool-command'
