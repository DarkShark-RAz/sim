...
import { InlineToolCall } from '@/app/workspace/[workspaceId]/components/panel/components/copilot/components'
import {
  FileAttachmentDisplay,
  SmoothStreamingText,
  StreamingIndicator,
  ThinkingBlock,
} from '@/app/workspace/[workspaceId]/components/panel/components/copilot/components/copilot-message/components'
import CopilotMarkdownRenderer from '@/app/workspace/[workspaceId]/components/panel/components/copilot/components/copilot-message/components/markdown-renderer'
import {
  useCheckpointManagement,
  useMessageEditing,
  useMessageFeedback,
  useSuccessTimers,
} from '@/app/workspace/[workspaceId]/components/panel/components/copilot/components/copilot-message/hooks'
import { UserInput } from '@/app/workspace/[workspaceId]/components/panel/components/copilot/components/user-input/user-input'
