...
import {
  ...
  Editor,
  Toolbar,
} from '@/app/workspace/[workspaceId]/components/panel/components'
import {
  usePanelResize,
  useUsageLimits,
} from '@/app/workspace/[workspaceId]/components/panel/hooks'
...
import { useDeleteWorkflow, useImportWorkflow } from '@/app/workspace/[workspaceId]/hooks'
...
export function Panel() {
  ...
  const handleAutoLayout = useCallback(async () => {
    ...
    try {
      ...
      const { applyAutoLayoutAndUpdateStore } = await import('../../utils/auto-layout-utils')
