...
import { CustomToolModal } from '@/app/workspace/[workspaceId]/components/panel/components/editor/components/sub-block/components/tool-input/components/custom-tool-modal/custom-tool-modal'
